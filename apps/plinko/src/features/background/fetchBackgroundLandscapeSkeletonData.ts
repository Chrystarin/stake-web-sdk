...
import { BACKGROUND_LANDSCAPE_SPINE_BASE } from '../../game/assets';
import { staticUrl } from '../../lib/staticUrl';

const resolveSrc = () => ({
	atlas: staticUrl(`${BACKGROUND_LANDSCAPE_SPINE_BASE}/landscape.atlas`),
	skeleton: staticUrl(`${BACKGROUND_LANDSCAPE_SPINE_BASE}/landscape.json`),
	images: {
		'landscape.png': staticUrl(`${BACKGROUND_LANDSCAPE_SPINE_BASE}/landscape.png`),
		'landscape2.png': staticUrl(`${BACKGROUND_LANDSCAPE_SPINE_BASE}/landscape2.png`),
	},
});
...
/** Loads v2 landscape spine skeleton data from static assets. */
export async function fetchBackgroundLandscapeSkeletonData(): Promise<SPINE_PIXI.SkeletonData> {
